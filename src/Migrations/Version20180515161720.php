 ...
 */
class Version20180515161720 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE suites ADD COLUMN created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE suites ADD COLUMN updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE __temp__cards');
        $this->addSql('CREATE INDEX IDX_4C258FD111948DC ON cards (deck_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__suites AS SELECT id, name, deleted_at FROM suites');
        $this->addSql('DROP TABLE suites');
        $this->addSql('CREATE TABLE suites (id INTEGER NOT NULL, name VARCHAR(64) NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO suites (id, name, deleted_at) SELECT id, name, deleted_at FROM __temp__suites');
