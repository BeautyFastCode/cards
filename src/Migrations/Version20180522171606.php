 ...
 */
class Version20180522171606 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE decks ADD COLUMN deleted_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE decks ADD COLUMN created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE decks ADD COLUMN updated_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('CREATE TABLE cards (id INTEGER NOT NULL, deck_id INTEGER NOT NULL, question VARCHAR(255) DEFAULT NULL COLLATE BINARY, answer VARCHAR(255) DEFAULT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_4C258FD111948DC FOREIGN KEY (deck_id) REFERENCES decks (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE __temp__cards');
        $this->addSql('CREATE INDEX IDX_4C258FD111948DC ON cards (deck_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__decks AS SELECT id, name FROM decks');
        $this->addSql('DROP TABLE decks');
        $this->addSql('CREATE TABLE decks (id INTEGER NOT NULL, name VARCHAR(64) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO decks (id, name) SELECT id, name FROM __temp__decks');
